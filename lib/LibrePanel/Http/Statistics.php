...
class Statistics
{
	...
	public static function createAWStatsConf(
		...
		$header2 = "## Do not remove the line above! This tells LibrePanel to update this configuration\n## If you wish to manually change this configuration file, remove the first line to make sure LibrePanel won't rebuild this file\n## Generated for domain {SITE_DOMAIN} on " . date('l dS \of F Y h:i:s A') . "\n";
		...
		$model_file = LibrePanel::getInstallDir() . '/templates/misc/awstats/awstats.librepanel.model.conf';
