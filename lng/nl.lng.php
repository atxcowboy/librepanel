...
return [
	'admin' => [
		...
		'ipsandports' => [
			...
			'docroot' => [
				'title' => 'Aangepaste docroot (leeg = verwijzing naar LibrePanel)',
		...
		'show_version_login' => [
			'title' => 'Toon versie van LibrePanel bij het inloggen',
			'description' => 'Toont de versie van LibrePanel in de voettekst van de inlogpagina',
		],
		'show_version_footer' => [
			'title' => 'Toon versie van LibrePanel in de voettekst',
			'description' => 'Toont de versie van LibrePanel in de voettekst op de rest van de pagina\'s',
		],
		'librepanel_graphic' => [
			'title' => 'Kopgrafiek voor LibrePanel',
		...
		'newerversionavailable' => 'Er is een nieuwe versie van LibrePanel beschikbaar',
		'cron' => [
		...
		'mod_fcgid_user' => 'Lokale gebruiker voor FCGID (LibrePanel vhost)',
		'mod_fcgid_group' => 'Lokale groep voor FCGID (LibrePanel vhost)',
	...
	'cron' => [
		...
		'changewarning' => 'Het aanpassen van de ze waarden kunnen van negatieve invloed zijn op het gedrag van LibrePanel en haar geautomatiseerde taken.<br />Pas deze waarden alleen aan wanneer u *zeer zeker* bent van wat u doet.',
	],
	'crondesc' => [
	...
	'domains' => [
		...
		'add_date' => 'Toegevoegd aan LibrePanel',
	...
	'mails' => [
		...
		'password_reset' => [
			...
			'mailbody' => 'Hallo {USERNAME},\\n\\nuw wachtwoord voor LibrePanel is opnieuw ingesteld!\\nHet nieuwe wachtwoord is: {LINK}\\n\\nMet vriendelijke groet,\\nuw beheerder',
		],
		'new_database_by_customer' => [
			'subject' => '[LibrePanel] Nieuwe database aangemaakt',
...
Met vriendelijke groet, uw beheerder',
	...
	'serversettings' => [
		...
		'mod_fcgid' => [
			...
			'defaultini_ownvhost' => 'Standaard configuratie voor LibrePanel-vHost',
		],
		'sendalternativemail' => [
		...
		'panel_allow_domain_change_customer' => [
			...
			'description' => 'Indien actief, kunt u de klant van een domein veranderen.<br /><b>Let op:</b> LibrePanel zal niet het pad aanpassen. Dit kan ervoor zorgen dat het domein onbruikbaar wordt!',
		],
		'cron' => [
			'debug' => [
		...
		'librepaneldirectlyviahostname' => 'LibrePanel is direct toegankelijk via hostnaam',
		...
		'mod_fcgid_ownvhost' => [
			'title' => 'FCGID inschakelen voor de VHost voor LibrePanel',
			'description' => 'Indien ingeschakeld wordt LibrePanel ook uitgevoerd onder een lokale gebruiker<br /><strong>Let op:</strong>Dit vereist handmatige configuratie, zie <a target="_blank" href="https://docs.librepanel.org/latest/admin-guide/configuration/fcgid/">FCGID - handbook</a>',
		],
		'perl' => [
			'suexecworkaround' => [
				'title' => 'Om SuExec heenwerken (Geldt alleen voor Apache)',
				'description' => 'Schakel dit alleen in indien de documentmappen van klanten niet in het pad van Apache SuExec vallen.<br />Indien ingeschakeld zal LibrePanel een symbolische link maken voor het pad waarvoor Perl actief is + /cgi-bin/.<br />Merk op dat Perl dan alleen werkt in de submap /cgi-bin/ en niet in de map zelf (zoals het werkt zonder deze oplossing!)',
			],
			'suexeccgipath' => [
	...
	'tasks' => [
		...
		'noneoutstanding' => 'Er zijn op dit moment geen uitstaande taken voor LibrePanel',
	],
	'traffic' => [
		'month' => 'Maand',
		'day' => 'Dag',
	...
	'update' => [
		'updateinprogress_onlyadmincanlogin' => 'Een nieuwere versie van LibrePanel is geinstalleerd maar is nog niet geconfigureerd.<br />Alleen de beheerder kan inloggen en de update voltooien.',
		'update' => 'LibrePanel Update',
		'proceed' => 'Verdergaan',
		'update_information' => [
			'part_a' => 'De bestanden van LibrePanel zijn bijgewerkt naar versie <strong>%s</strong>. De geinstalleerde versie is <strong>%s</strong>.',
			'part_b' => '<br /><br />Klanten kunnen niet inloggen totdat de update voltooid is.<br /><strong>Verdergaan?</strong>',
		],
		'noupdatesavail' => '<strong>U gebruikt reeds de meest recente versie van LibrePanel.</strong>',
	],
];
