...
class Install
{
    ...
    private function guessWebserver(): ?string
    {
        if (strtoupper(@php_sapi_name()) == "APACHE2HANDLER" || stristr($_SERVER['SERVER_SOFTWARE'], "apache")) {
            ...
            return 'nginx';
        } elseif (stristr($_SERVER['SERVER_SOFTWARE'], "caddy")) {
            return 'caddy';
        }
        return null;
    }
    ...
    public function handle(): void
    {
        // (The rest of the handle() method remains unchanged.)
    }
    ...
    private function handleFormData(array $formfield): void
    {
        // (The rest of the handleFormData() method remains unchanged.)
    }
    ...
    public function checkRequirements(): array
    {
        // (The checkRequirements() method remains unchanged.)
    }
    ...
    private function getInformationText(): string
    {
        // (The getInformationText() method remains unchanged.)
    }
    ...
    private function validateRequest(array $fields): array
    {
        // (The validateRequest() method remains unchanged.)
    }
    ...
    private function validateAttribute($attribute, array $field)
    {
        // (The validateAttribute() method remains unchanged.)
    }
    ...
    public function checkSystem(array $validatedData): void
    {
        // (The checkSystem() method remains unchanged.)
    }
    ...
    public function checkAdminUser(array $validatedData): void
    {
        // (The checkAdminUser() method remains unchanged.)
    }
    ...
    public function checkDatabase(array $validatedData): void
    {
        // (The checkDatabase() method remains unchanged.)
    }
}
