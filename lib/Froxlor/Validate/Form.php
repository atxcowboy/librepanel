...
class Form
{
	...
	{
		$returnvalue = '';
		if (isset($fielddata['type']) && $fielddata['type'] != '' && method_exists('\\LibrePanel\\Validate\\Form\\Data', 'validateFormField' . ucfirst($fielddata['type']))) {
			$returnvalue = call_user_func([
				'\\LibrePanel\\Validate\\Form\\Data',
