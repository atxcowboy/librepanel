			...
			'section_d' => [
				...
				'fields' => [
					...
					'dkim_entry' => [
						...
						'type' => 'longtext',
						'value' => (string)(new \LibrePanel\Dns\DnsEntry('dkim' . $result['dkim_id'] . '._domainkey', 'TXT', \LibrePanel\Dns\Dns::encloseTXTContent('v=DKIM1; k=rsa; p='.trim($result['dkim_pubkey']))))
					],
				]
			]
		]
